...
namespace WavefrontObj
{
    public class WavefrontObjFile
    {
        ...
        void _validateIndicies(int[] idx, int listLen, string errMsg)
        {
        ...
        void _processFaces(string v0, string v1, string v2)
        {
            string[][] subs = { v0.Split('/'), v1.Split('/'), v2.Split('/') };
            ...
            _validateIndicies(vIdx, verts.Count, "Invalid vertex index: ");
            _validateIndicies(tIdx, tCoords.Count,
        ...
        void _processTexCoords(string tc0, string tc1)
        {
            ...
            while ((l = sr.ReadLine()) != null)
            {
                ...
                switch (subs[0])
                {
                    ...
                    case "f":
                        ...
                        _processFaces(subs[1], subs[2], subs[3]);
                        break;
                    case "o":
                        if (subs.Length < 2)
                            throw new MalformedLineException(l);
                    ...
                    case "s":
                        ...
                        Console.WriteLine("WARNING: ignoring smooth shading "
                            + "element of value: " + subs[1]);
                        break;
                    case "v":
                        if (subs.Length < 4)
                            throw new MalformedLineException(l);
                    ...
                    case "vt":
                        ...
                        _processTexCoords(subs[1], subs[2]);
                        break;
                    default:
                        throw new
                            NotImplementedException("Support for elements of "
                                + "type " + subs[0]
